...
gcc -m32 -I lib/kernel -I kernel/ -c -fno-builtin -fno-stack-protector -o build/debug.o kernel/debug.c
...
ld -m elf_i386 build/main.o build/kernel.o build/init.o build/interrupt.o build/print.o build/timer.o build/debug.o \
